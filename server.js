...
// wrapper pour choper et log tous les events appinsights dans la bdd pg
...
// recup recursive des sous folders pour isoler le portail
...
// routes API
// recup la liste a plat des dossiers de la bdd
...
// recherche textuelle de fichiers avec filtres (tags, categorie, date, section)
...
// upload multiple de fichiers, verif session et parse metadata
...
// details d'un fichier (description, tags, portals, metadata) pour peupler le modal
app.get('/file_details', loginRequiredJson, async (req, res) => {
    try {
        ...
        // Expose les deux champs avec les clés attendues par canto_logic.js.
...
// delete de portal_files + clean de folder_id
...
// suppr definitive d'un fichier (bdd + azure storage blob)
...
// listing de tous les portails de l'administration
...
// assign d'un fichier au portail + check isolation
...
// login d'un client sur son portail dedie avec check mdp + session portal
...
// admin panel pour gerer les utilisateurs des portails clients
...
// proxy pour dl les fichiers et calculer la vitesse/perf de transfert
...
// recup des listes de sections et categories pour les filtres de la galerie
...
// generation a la volee d'un zip pour exporter tout un folder d'un coup
...
// ajoute ou suppr un fichier des favoris de l'user (bdd pg)
...
// link des folders au portail + check isolation
...
// refresh auto du token oauth canto (toutes les 4j)
